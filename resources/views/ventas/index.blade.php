    ...
    <div id="datosCliente" class="border-top pt-3">
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-4">
                ...
                <input type="number" id="precio_paquete" class="form-control border rounded-2 px-2" readonly>
            </div>
            <div class="col-md-4">
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-4">
                ...
                <input type="number" name="descuento" id="descuento" class="form-control border rounded-2 px-2" value="0">
            </div>
            <div class="col-md-4">
                <label class="form-label">Recargo Domicilio</label>
                <input type="number" name="recargo_domicilio" id="recargo_domicilio" class="form-control border rounded-2 px-2" value="0">
            </div>
            <div class="col-md-4">
                <label class="form-label">Recargo Falta Pago</label>
                <input type="number" name="recargo_falta_pago" id="recargo_falta_pago" class="form-control border rounded-2 px-2" readonly>
