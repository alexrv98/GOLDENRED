...
<div class="modal-body">
  <div class="row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="number" name="dia_cobro" class="form-control border" min="1" max="31" placeholder="Ej. 15" required>
    </div>
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" name="direccion" class="form-control border" placeholder="Ej. Calle 123, Colonia Centro">
    </div>
    ...
    <div class="col-md-12 mb-3">
      ...
      <textarea name="referencias" class="form-control border" rows="2" placeholder="Casa azul frente a la tienda."></textarea>
    </div>
  </div>
</div>
